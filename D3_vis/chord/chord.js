...
var width = 760,
    height = 820,
    outerRadius = Math.min(width, height) / 2 - 150,//100,
...
d3.csv("regionfish.csv", function(error, regionData) {
...
// });
//
// d3.select("#tentwlve").on("click", function() {
